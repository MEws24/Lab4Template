...
import austriantuber.vehicle.Volkswagen;
...
public class D3 extends TuberDriver {
    private Volkswagen volkswagen;

    // Constructor
    public D3() {
    	super("D3", new Location(2, 4)); 
    	System.out.println("[*] Setting Vehicle for driver: D3");
        this.volkswagen = new Volkswagen();
    }

	public Volkswagen getVehicle() {
		return volkswagen;
	}

	public String getVehicleType() {
		return volkswagen.getType();
	}

	public void setVehicle(Volkswagen volkswagen) {
