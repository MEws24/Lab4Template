 ...
 * </p>
 * <ul>
 *   <li>{@link tuber.impl.VehicleImpl#getName <em>Name</em>}</li>
...
public class VehicleImpl extends MinimalEObjectImpl.Container implements Vehicle {
	 ...
	 * @ordered
	 */
	protected static final VehicleType TYPE_EDEFAULT = VehicleType.MOTORBIKE;
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TuberPackage.VEHICLE__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case TuberPackage.VEHICLE__NAME:
			return getName();
