 ...
 *   <li>{@link tuber.impl.TUberImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TUberImpl extends MinimalEObjectImpl.Container implements TUber {
	/**
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TuberPackage.TUBER__NAME, oldName, name));
	}
